...
<head>
    ...
    <link rel="apple-touch-icon" href="{{ isset($setting['favicon']) ? asset('/'.str_replace('/xxx/', '/100/', $setting['favicon'])) : '' }}">
    <link rel="apple-touch-icon" sizes="72x72" href="{{ isset($setting['favicon']) ? asset('/'.str_replace('/xxx/', '/100/', $setting['favicon'])) : '' }}">
    <link rel="apple-touch-icon" sizes="114x114" href="{{ isset($setting['favicon']) ? asset('/'.str_replace('/xxx/', '/100/', $setting['favicon'])) : '' }}">
    ...
    @else
        <meta property="og:image" content="{{ isset($setting['favicon']) ? asset('/'.str_replace('/xxx/', '/100/', $setting['favicon'])) : '' }}">
    @endif
                ...
                <div class="container-fluid navbar-inner">
                    <div class="d-flex align-items-center justify-content-between w-100 landing-header">
                        <a href="{{url('/home')}}" class="navbar-brand m-0 d-xl-flex d-none">
                            <!--Logo start-->
                            <img src="{{ isset($setting['favicon']) ? asset('/'.str_replace('/xxx/', '/100/', $setting['favicon'])) : '' }}">
                            <!--logo End-->
