...
<head>
    ...
    <!-- Favicon -->
    <link rel="shortcut icon" href="{{ isset($setting['favicon']) ? asset('/'.str_replace('/xxx/', '/100/', $setting['favicon'])) : '' }}">
        ...
        <div class="sidebar-body pt-0 data-scrollbar">
            <div class="sidebar-list">
                ...
                <ul class="navbar-nav iq-main-menu" id="sidebar-menu">
                    ...
                    <li class="nav-item">
                        <a class="nav-link @if (str_contains($menu, 'bignumber')) {{'active'}} @endif" aria-current="page" href="{{ url('/admin/bignumber') }}">
                            <i class="icon">
                            ...
                            <span class="item-name">Big Number</span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link @if (str_contains($menu, 'team')) {{'active'}} @endif" aria-current="page" href="{{ url('/admin/team') }}">
                            <i class="icon">
                                <svg class="icon-24" width="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <li class="nav-item">
                        <a class="nav-link @if (str_contains($menu, 'partner')) {{'active'}} @endif" aria-current="page" href="{{ url('/admin/partner') }}">
                            <i class="icon">
                                <svg class="icon-24" width="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <li class="nav-item">
                        <a class="nav-link @if (str_contains($menu, 'testimony')) {{'active'}} @endif" aria-current="page" href="{{ url('/admin/testimony') }}">
                            <i class="icon">
                                <svg class="icon-24" width="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <span class="item-name">Testimony</span>
                        </a>
                    </li>
                    <li>
                        <hr class="hr-horizontal" style="background-color: white">
                    ...
                    <li class="nav-item">
                        <a class="nav-link @if (str_contains($menu, 'pricing')) {{'active'}} @endif" aria-current="page" href="{{ url('/admin/pricing') }}">
                            <i class="icon">
                                <svg class="icon-24" width="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <li class="nav-item">
                        <a class="nav-link @if (str_contains($menu, 'blog')) {{'active'}} @endif" aria-current="page" href="{{ url('/admin/blog') }}">
                            <i class="icon">
                                <svg class="icon-24" width="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <li class="nav-item">
                        <a class="nav-link @if (str_contains($menu, 'faq')) {{'active'}} @endif" aria-current="page" href="{{ url('/admin/faq') }}">
                            <i class="icon">
                                <svg class="icon-24" width="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
